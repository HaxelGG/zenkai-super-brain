...
4. **Fase 5 · domain swap apex** ✅ **SOP ejecutable listo** en `sops/sop-domain-swap-apex.md` v1.0 · 35 min activos + propagación DNS · IDs reales · orden zero-downtime (subdomain panel primero · swap apex después · ventana crítica <30s) · rollback documentado · 14 steps con checkboxes + 7 criterios de done. Subsume Tareas 5.3-pre + 5.3 del plan original. Ejecutable cuando quieras desde Vercel UI + Hostinger DNS.
